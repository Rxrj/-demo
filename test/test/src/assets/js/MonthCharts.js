...
function drawWorkingData(){
  ...
  var dateJune = new Date(2016,5,1);
  var day = dateJune.getDate();
  var week = dateJune.getDay();
  ...
  $.ajax({
    type:'get',
    url:"https://raw.githubusercontent.com/fengzi258/SOUP_data/main/pickup_dropoff/day_"+ String(day-1) + ".geojson",
    dataType:'JSON',
    success:function(data){
      chartsWorkingPick.setOption({
        series: [
          {
            name: '2016-6-'+day+'('+weekArray[week-1]+')',
            type: 'line',
            data: data.pickup,
            color:['#FF0000']
          },
